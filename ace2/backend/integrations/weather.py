# MIRROR OF ace-portal/backend/weather.py — copied verbatim, not rewritten.
...
async def get_weather() -> dict:
    ...
    base = {
        ...
        "temp": None,
        "condition": "",
        "description": "",   # only set on the success path upstream — declared here
                             # so error responses carry the key instead of omitting
                             # it and handing the weather card `undefined`
